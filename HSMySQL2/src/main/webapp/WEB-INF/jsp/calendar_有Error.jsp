...
<html lang="en">
    <head>
        ...
        <script>
            ...
            // --切換單位自動變換不同時段 (1)
            function displayCheckBox(gid, u_peroid) {
                console.log(gid);
                ...
                for (var i = 0; i < jsonData.length; i++) {
                    if (jsonData[i]['gid'] == gid) {
                        ...
                        no = no.substring(2);
                        tag += '<input type="radio" id="u_peroid" name="u_peroid" ' + ((u_peroid == no) ? "checked" : "") + ' value="' + no + '"> ' + jsonData[i]['class_name'] + '　';
                    }
                }
            ...
            function init() {
                ...
                var u_peroid = ${sessionScope.formData == null ? 0 : sessionScope.formData.u_peroid[0]};
                if (u_nop != '') {
                    var gid = u_nop == 'ho' ? 1 : u_nop == 'co' ? 2 : u_nop == 'ph' ? 3 : 4;
                    displayCheckBox(gid, u_peroid);
                }
            }
            ...
            function checkAll(tagName, flag) {
                //取得所有同名checkbox
        ...
        <div id="layout">
            ...
            <div id="main" style="display:${ showTable }">
                ...
                <form class="pure-form" method="post" action="/HSMySQL/mvc/console/calendar/update/batch">
                    ...
                    <!--<input type="checkbox" onchange="checkAll('u_month', this.checked)"> 全選-->
                    <p/>
                    週數：
                    ...
                    <input type="checkbox" onchange="checkAll('u_week', this.checked)"> 全選
                    星期：
                    ...
                    <!--<input type="checkbox" onchange="checkAll('u_weekday', this.checked)"> 全選-->
                    <p />
                    <!--                    單位：
                ...
                <form class="pure-form" method="post" action="/HSMySQL/mvc/console/calendar/update/batch2">
